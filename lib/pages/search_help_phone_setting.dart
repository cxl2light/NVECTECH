...
/// 搜索手机设置
class SearchHelpPhoneSetting extends StatefulWidget{
  final List<SwiperPageBean> imgList;
  SearchHelpPhoneSetting({Key? key, required this.imgList}) : super(key:key);
...
class _State extends State<SearchHelpPhoneSetting> {
                ...
                return Row(
                  children: [
                    ...
                    Align(
                      ...
                      child: Image.asset(widget.imgList[index].url, width: 240),
                    ),
                    const SizedBox(
                      width: 20,
                    ),
